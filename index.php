...
<div class="container main">
  <h2>Швидка допомога при загрозі</h2>
    <ul class="nav nav-tabs">
        <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="index.php">Всі пости</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="categories/first.php">Обстріли та мінування</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="categories/second.php">Окупація</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="categories/third.php">Перша допомога</a>
        </li>
    </ul>
  <div class="row">
      <div class="col">
